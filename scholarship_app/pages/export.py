...
if main_data is None:
    st.write("No master data imported, once you import data and save it to the master sheet in sharepoint you can return to export data and download that sheet at any point")
else:
    ...
    with open(f"{get_appdata_path('temp/download')}/student_data_export.xls", "rb") as file:
        st.download_button(
            label="Export",
            data=file,
