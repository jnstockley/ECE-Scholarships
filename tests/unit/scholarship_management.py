...
from scholarship_app.utils.scholarship_management import read_rows, write_rows, edit_row, groups_string_to_list, check_columns_equal, equalize_dictionary_columns
...
class ScholarshipManagementTest(unittest.TestCase):
    ...
    def setUp(self):
        self.scholarships = {'Name': ['Test Scholarship'], 'Total Amount': ['1000'], 'Value': ['2000'], 'RAI': ['315'],
                             ...
                             'ACT Composite': ['25'], 'SAT Math': ['500'], 'SAT Reading': ['400'],
                             'SAT Combined': ['1000'],
        ...
        self.columns_invalid = ['Name', 'Total Amount', 'Value', 'RAI', 'Admit Score', 'Major', 'ACT Math',
                                'ACT English',
                                'ACT Composite', 'SAT Math', 'Bad Column', 'SAT Reading', 'SAT Combined', 'GPA',
                                'HS Percentile',
        ...
        self.columns_invalid_missing = ['Name', 'Total Amount', 'RAI', 'Admit Score', 'Major', 'ACT Math',
                                        'ACT English',
                                        'ACT Composite', 'SAT Math', 'Bad Column', 'SAT Reading', 'GPA',
                                        'HS Percentile',
    ...
    def test_write_rows(self):
        ...
        """
        write_rows(self.scholarships_df, 'tests/data/scholarships_test_file.xlsx', 'Scholarships', self.creds)
    ...
    def test_read_edit_write_rows(self):
        ...
        write_rows(rows, 'tests/data/scholarships_test_file.xlsx', 'Scholarships', self.creds)
