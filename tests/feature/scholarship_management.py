...
def test_scholarship_page(page: Page):
    ...
    scholarship_heading = page.get_by_role(
        "heading", name="Scholarship Management"
    ).get_by_text("Scholarship Management")
...
def test_create_button(page: Page):
    ...
    """
    page.goto(
        "http://localhost:9000/Scholarship%20Management", wait_until="domcontentloaded"
    )
...
def test_import_page(page: Page):
    ...
    import_heading = page.get_by_role(
        "heading", name="Import Scholarships"
    ).get_by_text("Import Scholarships")
