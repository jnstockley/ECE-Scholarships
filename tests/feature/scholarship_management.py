...
# def test_requirement_groupings(page: Page):
#     '''
#     As a user I should be able to add requirement groupings to a scholarship
#     '''
#     page.goto("http://localhost:9000/Scholarship%20Management")
#     page.get_by_role("button", name="Create New Scholarship").click()
#     group_one_btn = page.get_by_role("button", name="Add a Requirement Grouping")
#     group_one_btn.click()
#     group_two_btn = page.get_by_role("button", name="Add a second Requirement Grouping")
#     group_two_btn.click()
#     group_three_btn = page.get_by_role("button", name="Add a third Requirement Grouping")
#     group_three_btn.click()
